...
class Config(PrintableConfig):
    ...
    def save_config(self) -> None:
        ...
        config_gt_path = base_dir / "gt.txt"
        CONSOLE.log(f"Saving worldtogt to: {config_gt_path}")
        meta = load_from_json(self.pipeline.datamanager.dataparser.data / "meta_data.json")
        config_gt_path.write_text(yaml.dump(meta["worldtogt"]), "utf8")
